...
const translations = {
    ...
    vi: {
        ...
        'edu-2-2': 'Bài báo khoa học tại hội nghị COMBELT 2026',
        ...
        'lesson3-title': 'Bài 3: Vòng lặp và Lặp lại - Code Up Your Brain',
        'lesson3-meta': 'Làm chủ vòng lặp trong Python với for, while và nested loops. Học các kỹ thuật lặp và ứng dụng thực tế.',
        'lesson3-main-title': 'Vòng lặp và Lặp lại',
        'lesson3-subtitle': 'Làm chủ sức mạnh của việc lặp lại trong lập trình với for loops, while loops và nested iterations',
        'lesson3-duration': '60 phút',
        'lesson3-difficulty': 'Cơ bản',
    ...
    en: {
        ...
        'edu-2-2': 'Submitted scientific paper at COMBELT 2026 conference',
